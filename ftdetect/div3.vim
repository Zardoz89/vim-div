...
" source code
autocmd BufRead,BufNewFile *.[pP][rR][gG] if !search('gemix\|\_use_cstyle\|\include\|\typedef\|\declare\|\methods\|\callback\|\u\?int8\|\u\?int16\|\u\?int32\|\u\?int64\|\float\|\double', 'nw') | set filetype=div3 | endif
